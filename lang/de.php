...
return [
    ...
    'trip.form.description_hint' => 'Optional. Kann später von KI vorbefüllt werden.',
    ...
    'trip.map.geocaching_gpx_hint' => 'Gefundene Caches (erkannt über GSAK-Markierung oder eigenen "Gefunden"-Log) werden als Sehenswürdigkeiten mit ihrem cache_type-Icon übernommen. Erneuter Import derselben Datei aktualisiert bestehende Einträge statt sie zu verdoppeln.',
    'trip.map.geocaching_gpx_upload_error' => 'Bitte eine GPX-Datei auswählen.',
    'trip.map.geocaching_gpx_none_found' => 'Keine gefundenen Caches in dieser Datei erkannt.',
    'trip.map.geocaching_gpx_imported' => ':count gefundene(r) Cache(s) importiert.',
