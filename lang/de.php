...
return [
    ...
    'trip.map.track_gap_fill' => 'Lücken mit Fotopositionen füllen',
    'trip.map.track_gap_fill_hint' => 'Ergänzt den Track an Stellen ohne Abdeckung (mind. 15 Min. ohne Trackpunkt) mit den Standorten eigener Fotos. Bereits abgedeckte Stellen bleiben unverändert.',
    'trip.map.track_gap_fill_result' => ':count Track-Punkt(e) aus Fotopositionen ergänzt.',
