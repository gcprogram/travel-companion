...
return [
    ...
    'trip.form.description_hint' => 'Optional. Can be pre-filled by AI later.',
    ...
    'trip.map.geocaching_gpx_hint' => 'Found caches (detected via a GSAK found flag or your own "Found it" log) are added as sights with their real cache_type icon. Re-importing the same file updates existing entries instead of duplicating them.',
    'trip.map.geocaching_gpx_upload_error' => 'Please choose a GPX file.',
    'trip.map.geocaching_gpx_none_found' => 'No found caches detected in this file.',
    'trip.map.geocaching_gpx_imported' => ':count found cache(s) imported.',
