...
return [
    ...
    'trip.map.poi_discover_hint' => 'Looks up museums, monuments, sacred buildings, zoos and viewpoints near the route via OpenStreetMap. Runs in the background — reload this page in a minute to see results.',
